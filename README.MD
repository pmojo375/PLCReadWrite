This program is a GUI that allows you to read and write to an Allen Bradley PLC. It has the ability to read tags and write the results to a YAML file and write tags from data in a YAML file as well.
